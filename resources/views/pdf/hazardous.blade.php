...
<table style="width:100%; margin-bottom: 4px;">
    <tr>
        <td style="width: 25%; vertical-align: middle;">
            <div style="font-size: 18px; font-weight: bold; font-style: italic;">ecogreen</div>
        </td>
        <td style="width: 75%; text-align: center; vertical-align: middle;">
            <h1>HAZARDOUS WASTE CONSIGNMENT NOTE</h1>
            <div style="font-size: 8px;">www.ecogreenitrecycling.co.uk - ☎03301243053 - recycling@ecogreenitrecycling.co.uk</div>
        </td>
    </tr>
</table>
...
<table class="bordered" style="margin-bottom: 4px;">
    <tr>
        <td colspan="2" class="section-header">PART A: Notification Details</td>
    </tr>
    <tr>
...
<table class="bordered" style="margin-bottom: 4px;">
    ...
    <tr>
        <td colspan="4" style="padding: 3px;">
            <span class="label">1. The process giving rise to the waste(s) was:</span>
            <span class="value">IT Equipment Disposal</span>
        </td>
        <td colspan="3" style="padding: 3px;">
            <span class="label">2. SIC for the process giving rise to the waste:</span>
            <span class="value">46510</span>
        </td>
    </tr>
    <tr>
...
<table class="bordered" style="margin-bottom: 0; margin-top: -2px;">
    <tr>
        ...
        <th style="width: 10%;">EWC Code</th>
        <th style="width: 8%;">Quantity</th>
        <th style="width: 12%;">Approx Weight (kg)</th>
        <th style="width: 12%;">Total Weight (kg)</th>
...
<!-- EWC handling table -->
<table class="bordered" style="margin-bottom: 4px; margin-top: 4px;">
    <tr>
        <td colspan="7" style="padding: 3px; font-size: 9px;">
            <span class="label">The information below is to be completed for each EWC identified handling</span>
        </td>
    </tr>
    <tr>
        <th>EWC Code</th>
        <th>UN identification number(s)</th>
        <th>Proper Shipping name(s)</th>
        <th>UN class(es)</th>
        <th>Packaging group(s)</th>
    ...
    <tr>
        <td style="width: 48%; vertical-align: top; padding-right: 3px;">
            <table class="bordered" style="width: 100%;">
                <tr>
                    <td class="section-header">PART C – Carrier Certificate</td>
                </tr>
                <tr>
                    <td style="padding: 4px; font-size: 9px; line-height: 1.6;">
                        (If more than one carrier is used, please attach a schedule for subsequent
                        carriers. If a schedule of carriers is attached tick here) <span class="checkbox"> </span>
                        <br/><br/>
        ...
        <td style="width: 52%; vertical-align: top; padding-left: 3px;">
            <table class="bordered" style="width: 100%;">
                <tr>
                    <td class="section-header">PART D – Consignor's Certificate</td>
                </tr>
                <tr>
                    <td style="padding: 4px; font-size: 9px; line-height: 1.6;">
                        I certify that the information in A, B &amp; C has been completed and is correct, that
                        the carrier is registered or exempt and was advised of the appropriate
                        precautionary measures. All of the waste is packaged and labelled correctly and
                        the carrier has been advised of any special handling requirements.
                        <br/><br/>
...
<table class="bordered" style="margin-bottom: 4px;">
    ...
    <tr>
        ...
        <th>Quantity of each EWC code received (KG)</th>
...
<div style="font-size: 8px; margin-top: 6px; line-height: 1.4;">
    I CERTIFY THAT WASTE PERMIT / EXEMPT WASTE OPERATION NUMBER: EXP/MP3646YY AUTHORISES THE MANAGEMENT OF THE WASTE DESCRIBED
    IN B AT THE ADDRESS GIVEN IN A4 WHERE THE CONSIGNMENT FORMS PART OF A MULTIPLE CONNECTIONS, AS IDENTIFIED IN PART C.
    <br/><br/>
    THE COLLECTIONS ARE: ____________________
</div>
